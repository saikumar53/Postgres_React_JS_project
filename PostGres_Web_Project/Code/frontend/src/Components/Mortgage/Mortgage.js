...
class Mortgage extends Component {
    ...
    getItems(){
        fetch('http://localhost:3000/loan/getallMortgage')
      ...
      getDataItem(event){
        ...
        console.log(data);
        var request = new Request('http://localhost:3000/loan/getMortgage', {
            method : 'POST',
        ...
        return (
            <div style={{ display: 'flex', justifyContent: 'center', padding: 30 }}>
                <div><h2>Mortgage Details</h2>
                    ...
                    <br/><br/>
                    <form>
                        <Button variant="btn btn-success" onClick={() => history.push('/AddMortgage')}>Insert Mortgage Data</Button>
                    </form> 
                </div>
                <Container>
                    <Row>
                        <Col>
                        <MortTable items={this.state.items} />
                        </Col>
                    </Row>
                </Container>
